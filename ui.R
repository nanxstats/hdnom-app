...
shinyUI(
  navbarPage(
    ...
    navbarMenu('Model Validation',

               tabPanel(title = 'Internal Validation',
                        ...
                        fluidRow(
                          ...
                          column(width = 4, offset = 1,
                                 sidebarPanel(width = 12,
                                              ...
                                              selectInput('validate_tauc_type', label = 'Time-dependent AUC type:',
               ...
               tabPanel(title = 'Internal Calibration',
               ...
               tabPanel(title = 'Kaplan-Meier Analysis for Internal Calibration',
                        ...
                        fluidRow(
                          ...
                          column(width = 4, offset = 1,
                                 sidebarPanel(width = 12,
                                              ...
                                              actionButton(inputId = 'calcCalibrateKMButton',
               ...
               tabPanel(title = 'External Validation',

                        fluidRow(

                          column(width = 4, offset = 1,
                                 sidebarPanel(width = 12,
                                              radioButtons('ext_val_sep_type', label = 'Delimiter Type:',
                                                           choices = list('Comma' = 'comma', 'Tab' = 'tab', 'Semicolon' = 'semi'),
                                                           selected = 'comma'),
                                              fileInput('ext_val_filex', label = 'Upload design matrix of the external dataset:'),
                                              p(a('Sample data x (Comma-separated)', href = 'example/x_new.csv', target = '_blank'),
                                                br(),
                                              ...
                                              p(a('Sample data y (Comma-separated)', href = 'example/y_new.csv', target = '_blank'),
                                                br(),
                                              ...
                                              selectInput('external_validate_tauc_type', label = 'Time-dependent AUC type:',
                                                          choices = list('Uno (2007)' = 'UNO',
                                                                         'Song & Zhou (2008)' = 'SZ',
                                                                         'Chambless & Diao (2006)' = 'CD'),
                                                          selected = 'UNO'),
                                              ...
                                              actionButton(inputId = 'calcExternalValidateButton',
                                                           label = 'Validate the Model',
                                                           icon = icon('cogs'), class = 'btn-primary')
                                 )
                          ),
                          ...
                          column(width = 6,
                                 mainPanel(width = 12,
                                           tabsetPanel(
                                             ...
                                             tabPanel('External Validation Summary',
                                                      h3('Time-Dependent AUC Summary at Evaluation Time Points'),
               ...
               tabPanel(title = 'External Calibration',

                        fluidRow(

                          column(width = 4, offset = 1,
                                 sidebarPanel(width = 12,
                                              radioButtons('ext_cal_sep_type', label = 'Delimiter Type:',
                                                           choices = list('Comma' = 'comma', 'Tab' = 'tab', 'Semicolon' = 'semi'),
                                                           selected = 'comma'),
                                              ...
                                              sliderInput('external_calibrate_xlim_lo', label = 'Lower limit of plot range:',
                                                          min = 0.01, value = 0.85, max = 1, step = 0.01),
                                              sliderInput('external_calibrate_xlim_up', label = 'Upper limit of plot range:',
                                                          min = 0.02, value = 1, max = 1, step = 0.01),
                                              actionButton(inputId = 'calcExternalCalibrateButton',
                                                           label = 'Calibrate the Model',
                                                           icon = icon('wrench'), class = 'btn-primary')
                                 )
                          ),
                          ...
                          column(width = 6,
                                 mainPanel(width = 12,
                                           tabsetPanel(
                                             ...
                                             tabPanel('External Calibration Summary',
               ...
               tabPanel(title = 'Kaplan-Meier Analysis for External Calibration',
                        ...
                        fluidRow(
                          ...
                          column(width = 4, offset = 1,
                                 sidebarPanel(width = 12,
                                              ...
                                              actionButton(inputId = 'calcExternalCalibrateKMButton',
                                                           label = 'Perform K-M Analysis & Log-Rank Test',
                                                           icon = icon('wrench'), class = 'btn-primary')
                                 )
                          ),
    ...
    navbarMenu('Model Comparison',

               tabPanel(title = 'by Validation',
                        ...
                        fluidRow(
                          ...
                          column(width = 4, offset = 1,
                                 sidebarPanel(width = 12,
                                              ...
                                              selectInput('compare_validate_tauc_type', label = 'Time-dependent AUC type:',
                                                          choices = list('Uno (2007)' = 'UNO',
                                                                         'Song & Zhou (2008)' = 'SZ',
                                                                         'Chambless & Diao (2006)' = 'CD'),
                                                          selected = 'UNO'),
                                              ...
                                              actionButton(inputId = 'calcCompareValidateButton',
                          ...
                          column(width = 4, offset = 1,
                                 sidebarPanel(width = 12,
                                              ...
                                              sliderInput('compare_calibrate_xlim_lo', label = 'Lower limit of plot range:',
                                                          min = 0.01, value = 0.85, max = 1, step = 0.01),
                                              sliderInput('compare_calibrate_xlim_up', label = 'Upper limit of plot range:',
                                                          min = 0.02, value = 1, max = 1, step = 0.01),
                                              actionButton(inputId = 'calcCompareCalibrateButton',
                                                           label = 'Compare Models',
                                                           icon = icon('wrench'), class = 'btn-primary')
                                 )
                          ),
               ...
               column(width = 3,
                      sidebarPanel(width = 12,
                                   numericInput('prediction_pred_at',
                                                ...
                                                min = 0, value = 365),
                                   actionButton(inputId = 'calcPredictionButton',
