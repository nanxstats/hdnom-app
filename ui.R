        ...
        column(
          ...
          sidebarPanel(
            ...
            conditionalPanel(
              ...
              p("Please read our ", a("data privacy policy", href = "https://github.com/nanxstats/hdnom-doc/blob/master/privacy.md", target = "_blank"), "before uploading any data."),
              p("Read a detailed explanation about the ", a("upload data format", href = "https://github.com/nanxstats/hdnom-doc/blob/master/upload.md", target = "_blank"), ". An example dataset is provided below."),
        ...
        column(
          ...
          sidebarPanel(
            ...
            p(
              ...
              a("hdnom appmaker", href = "https://github.com/nanxstats/hdnom-appmaker", target = "_blank"),
